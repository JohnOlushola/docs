...
description: MindsDB provides various data and app handlers that let you connect virtually any data source and make use of your data to finetune models or make predictions.
mode: wide
---

The types of data sources include databases, data lakehouses, data warehouses, and applications.
