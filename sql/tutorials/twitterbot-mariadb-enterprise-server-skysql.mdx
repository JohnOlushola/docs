...
description: Want to use generative AI to automate your customer or user interactions? This tutorial shows you step-by-step how to build an interactive Twitter Bot using ChatGPT, MindsDB and MariaDB Enterprise Server in roughly 30-60 minutes.
---

_Author: [Pieter Humphrey](https://www.twitter.com/pieterhumphrey), MariaDB_

You can follow along with this [tutorial on YouTube](https://www.youtube.com/watch?v=uqn3MLCUhYU) as well.
...
[Accessing SkySQL Connect Dialog](https://github.com/mindsdb/mindsdb/blob/staging/docs/assets/tutorials/twitter_chatbot/mariadb-sky-connect.gif)
